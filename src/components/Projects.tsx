...
const projects = [
  ...
  },
  {
    ...
    demoUrl: "https://amphitheatre-booking-git-main-mritunjai-singhs-projects.vercel.app",
    githubUrl: "https://github.com/mritunjai-prog",
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Some of my recent work and contributions showcasing my skills in AI/ML, web development, and system design
          </p>
        </AnimatedSection>
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-primary/10 border border-primary/20">
                      ...
                      <span className="text-xs font-medium text-primary">{project.date}</span>
                    </div>
                  </div>
                  ...
                  <p className="text-base text-primary mb-4 font-semibold">{project.subtitle}</p>
